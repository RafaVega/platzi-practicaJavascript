//  DEEP COPY, copiar/clonar objetos
const obj1 = {
    a: "a",
    b: "b",
    c: {
...
//estas 2 funciones son funciones de validacion de datos, estan seran llamads y se les 
//pasaran un parametro, la mayoria de datos se puede validar con typeof, ergo, 
//los arrays son los unicos que tienen un metodo espacial = Array.isArray(objetoAsaberSiEsUnArray)

function deepCopy(subject) {
    let copySubject;
//dentro de sta funcion sucedera todo,el copysubject guardara los datos, este esta 
//esperando a saber si los datos son objetos,arrays u otras cosas como strings
